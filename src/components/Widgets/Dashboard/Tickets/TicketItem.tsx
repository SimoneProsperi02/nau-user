...
> = (props) => {
  ...
  return (
    <div className="grid grid-cols-2 border mb-2 rounded-[10px] p-4 bg-[#e6e6e64f]">
      <div className="grid grid-cols-3 ">
        <div className="col-span-1">
          <p className="font-bold">{id}</p>
          <p className="text-sm">{formattedOpenDate}</p>
        </div>
        <div className="col-span-2">
          <p className="text-clamp text-[12px] ">{content}</p>
      ...
      <div className="grid grid-cols-3">
        <p className="text-sm  ml-2">{formattedMessageDate}</p>
        <p>
          {isAnswered ? (
